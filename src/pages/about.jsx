  ...
  return (
    <div className="bg-gradient text-black min-h-screen py-12 px-6 md:px-16">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#55037b] font-Chakra">
          Introduction
        </h1>
        <p className="mt-4 px-4 lg:px-auto text-sm lg:text-lg text-gray-800 font-open-sans">
      ...
      <div className="max-w-4xl mx-auto mt-12">
        <h2 className="text-xl lg:text-2xl font-semibold text-cyan-800 font-Chakra">
          Mission & Vision
        </h2>
        <p className="mt-2 text-gray-700 font-open-sans text-xs md:text-base">
        ...
        <p className="text-gray-700 font-open-sans pt-2 text-xs md:text-base">
      ...
      <div className="max-w-4xl mx-auto mt-4 lg:mt-12">
        ...
        <ul className="mt-2 lg:mt-4 space-y-3 text-gray-700 font-open-sans text-xs md:text-base">
          <li>
      ...
      <div className="max-w-4xl mx-auto mt-8 lg:mt-12">
        <h2 className="text-lg lg:text-2xl font-semibold text-cyan-800 font-Chakra">
          Who Can Use PsychoTalk?
        </h2>
        <ul className="mt-4 space-y-3 text-gray-700 font-open-sans text-xs md:text-base pl-2">
          <li>
      ...
      <div className="max-w-4xl mx-auto mt-8 lg:mt-12 text-center">
        <h2 className="text-lg lg:text-2xl font-semibold text-cyan-800 font-Chakra">
          Why Choose PsychoTalk?
        </h2>
        <p className="mt-4 text-gray-700 font-open-sans text-xs md:text-base">
          ✔ Safe and anonymous platform fostering open sharing without fear of judgment.
        </p>
        <p className="text-gray-700 font-open-sans text-xs md:text-base">
      ...
      <div className="max-w-4xl mx-auto mt-12 text-center border-t border-gray-700 pt-6">
        ...
        <p className="text-gray-900 font-open-sans text-xs md:text-base">
